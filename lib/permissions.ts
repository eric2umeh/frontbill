...
export type { PermissionOverrides } from '@/lib/permission-overrides'
...
export const ALL_PERMISSIONS: {
  ...
  {
    key: "bookings:create",
    label: "Create Bookings & Bulk Bookings",
    group: "Bookings",
  },
  ...
  {
    key: "room_change:approve",
    label: "Approve Room Change Requests",
    group: "Bookings",
  },
  {
    key: "reschedule_stay:request",
    label: "Request move stay dates (approval)",
    group: "Bookings",
  },
  {
    key: "reschedule_stay:approve",
    label: "Approve Move Stay Dates Requests",
    group: "Bookings",
  },
  ...
  },
  {
    ...
    label: "Create Reservations & Bulk Reservation",
    group: "Reservations",
  },
  {
  ...
  },
  {
    ...
    label: "Cancel/Delete Reservations",
    group: "Reservations",
  },
  ...
  {
    key: "expenses:create",
    label: "Record Operating Expenses",
    group: "Expenses",
  },
  { key: "expenses:edit", label: "Edit Operating Expenses", group: "Expenses" },
  {
    key: "expenses:export",
    label: "Import/Export Expenses",
    group: "Expenses",
  },
  {
    key: "expenses:budget",
    label: "Manage Expense Budgets",
    group: "Expenses",
  },
  ...
  {
    key: "housekeeping:create",
    label: "Create Housekeeping Log Entries",
    group: "Housekeeping",
  },
  {
    key: "housekeeping:edit",
    label: "Update Housekeeping Tasks",
    group: "Housekeeping",
  },
  {
    key: "housekeeping:assign",
    label: "Assign Housekeeping Work",
    group: "Housekeeping",
  },
  {
    key: "housekeeping:report",
    label: "Submit Housekeeping Daily Reports",
    group: "Housekeeping",
  },
  ...
  { key: "maintenance:view", label: "View Maintenance", group: "Maintenance" },
  {
    ...
    label: "Create Maintenance Log Entries",
    group: "Maintenance",
  },
  {
    key: "maintenance:edit",
    label: "Update Maintenance Work",
    group: "Maintenance",
  },
  {
    key: "maintenance:assign",
    label: "Assign Maintenance Work",
    group: "Maintenance",
  },
  {
    key: "maintenance:report",
    label: "Submit Maintenance Daily Reports",
    group: "Maintenance",
  },
  ...
  {
    key: "store:adjust",
    label: "Stock In / Out & Adjustments",
    group: "Store",
  },
  {
    key: "store:issue",
    label: "Issue Stock to Outlets / Departments",
    group: "Store",
  },
  {
    key: "store:reports",
    label: "Store reports (daily closing & monthly management report)",
    group: "Store",
  },
  {
    key: "store:audit",
    label: "Store Movement Audit Trail (Full Detail)",
    group: "Store",
  },
  {
    key: "store:requisition",
    label: "Store Requisitions (request items from store)",
    group: "Store",
  },

  {
    key: "outlet:view",
    label: "View Outlets (FnB / Laundry / Gym)",
    group: "Outlets",
  },
  {
    key: "outlet:menu",
    label: "Manage Outlet Menu (categories & items)",
    group: "Outlets",
  },
  ...
  {
    key: "outlet:delete",
    label: "Delete / Void Outlet Orders",
    group: "Outlets",
  },
  {
    key: "outlet:reports",
    label: "Outlet Sales Reports & Night Audit",
    group: "Outlets",
  },
  {
    key: "outlet:receipt",
    label: "Print / View Outlet Receipts",
    group: "Outlets",
  },

  {
    key: "supply:store",
    label: "Central Store (stock & PO basket)",
    group: "Supply Chain",
  },
  {
    key: "supply:kitchen",
    label: "Kitchen batches & recipes",
    group: "Supply Chain",
  },
  {
    key: "supply:fnb",
  ...
  {
    key: "supply:purchasing",
    label: "Market retirement & PO",
    group: "Supply Chain",
  },
  {
    key: "supply:approve_accountant",
    label: "Approve PO (Accountant)",
    group: "Supply Chain",
  },
  {
    key: "supply:approve_manager",
    label: "Approve PO (Manager)",
    group: "Supply Chain",
  },
  {
    key: "supply:activity",
    label: "Supply chain activity log",
    group: "Supply Chain",
  },
  ...
  {
    key: "ledger:manage",
    label: "Manage City Ledger Balances",
    group: "City Ledger",
  },

  {
    key: "reconciliation:view",
  ...
  {
    key: "settings:manage",
    label: "Manage Hotel/System Settings",
    group: "Settings",
  },

  {
    key: "backdate:request",
    label: "Request Backdated Booking/Reservation",
    group: "Night Audit",
  },
  {
    key: "backdate:approve",
    label: "Approve/Reject Backdates (Night Audit)",
    group: "Night Audit",
  },
];
...
export const ROLE_DEFINITIONS: RoleDefinition[] = [
  ...
  },
  {
    ...
    label: "Cashier",
    description:
      "Cash control and daily treasury: outlets POS (default home), transactions, payments, and reports; print receipts and outlet daily reports; record cash received from front desk; post operating expenses and refunds; read-only on bookings, reservations/events, guests, and organizations (no menu edits). No dashboard. Cannot create, edit, or delete bookings, reservations, events, guests, or organizations. No Night Audit menu, user administration, analytics, or ledger settlement.",
  ...
  },
  {
    ...
    label: "Front Desk",
    description:
      "Front office: new walk-ins and group/bulk bookings, reserve workflows and reserve check-ins from operational lists, check-out, folio charges and extensions where policy allows, payments, city ledger posting, organization creation for corporates, night audit run plus audit trail review, and backdate requests. Creating guest profiles is allowed; editing or deleting guest profiles is reserved for Manager, Administrator, or Superadmin. Master edits to bookings, reservations, organizations, or room inventory are reserved for Administrators.",
  ...
  },
  {
    ...
    label: "Receptionist",
    description:
      "Lobby team: monitors live bookings and arrivals, executes check-ins/check-outs, verifies payments on folios that are unlocked for their role, and keeps guest lookups current. Creating new bookings or reservations happens through front desk supervisors; housekeeping status is read-only from this persona.",
  ...
  },
  {
    ...
    label: "Staff",
    description:
      "Lightweight oversight: confirms room states on the housekeeping board plus upcoming reservations/bookings for scheduling; used by operations floaters.",
...
export const APP_LOGIN_ROLE_KEYS: readonly RoleKey[] = ROLE_DEFINITIONS.map(
  (r) => r.key,
);
 ...
 */
export function canonicalRoleKey(
  userRole: string | null | undefined,
): RoleKey | null {
  if (!userRole) return null;
  const s = String(userRole)
    .trim()
    .toLowerCase()
    .replace(/[\s-]+/g, "_");
  if (!s) return null;
...
export function canIssueStockFromStore(
  ...
  if (
    hasPermission(userRole, "store:issue") ||
    hasPermission(userRole, "store:adjust")
  ) {
    return true;
  }
...
export function hasPermission(
  ...
  if (parsed && ((parsed.grants?.length ?? 0) > 0 || (parsed.denies?.length ?? 0) > 0)) {
    return hasPermissionWithOverrides(roleKey, permission, parsed);
  }
...
export function resolveEffectivePermissions(
  ...
  for (const d of overrides?.denies ?? []) {
