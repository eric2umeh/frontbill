...
/** Snapshot keys kitchen-only roles may upsert (includes kitchen-raised POs). */
...
/**
 * Snapshot keys F&B / cashier / bar staff may upsert for physical counts and POS deduct.
 * Do not include POs, recipes, or issue-out — those stay store/kitchen-gated.
 */
