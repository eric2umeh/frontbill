...
export const MOCK_STORE_ITEMS: StoreItem[] = [
  ...
  },
  {
    ...
    unit: "bag",
    dept: "kitchen",
    kitchenCategory: "rice_grains",
    quantityInStore: 12,
    reorderLevel: 4,
    lastPrice: 38000,
    benchmarkPrice: 37500,
  },
  {
    id: "stk-tomato",
    name: "Tomatoes",
...
export const MOCK_KITCHEN_STOCK: KitchenStockItem[] = [
  {
    ...
    availablePortions: 0,
    reorderLevel: 2,
    linkedRecipeId: "rcp-pepper-chicken",
  },
  {
    id: "ks-jollof",
    name: "Jollof Rice",
