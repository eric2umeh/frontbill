...
/** Store dept filter pills — fill only when selected; count has no filled background. */
export function DeptPill({
  ...
  return (
    <span className="relative inline-flex shrink-0 pt-1 ml-1">
      ...
      {showCount && (
        <span
          className="pointer-events-none absolute right-0 top-0 z-10 flex h-5 min-w-5 -translate-y-1/2 translate-x-1/2 items-center justify-center rounded-full px-1 text-[10px] font-semibold leading-none text-muted-foreground tabular-nums"
