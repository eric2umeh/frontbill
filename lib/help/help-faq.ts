...
export const HELP_FAQ: HelpFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Use the Stay date picker. It lists everyone occupying that hotel night (arrivals + stayovers), not only people who checked in that day. Clear the date to return to today’s list. Default today view shows occupied, due out today (with a Due note), and today’s arrivals.',
